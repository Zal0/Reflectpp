...
#define SERIALIZED_FIELD_VECTOR(ACCESS, TYPE, NAME)    ReflectInfo(ReflectInfo::REFLECT_TYPE_VECTOR_CLASS, #NAME, OFFSET(NAME), (PTR)VectorHandlerT< TYPE, TYPE >::GetVectorHandler),
